export const PRODUCTS = [
  ...
  },
  {
    ...
    weight: "500ml",
    title: "Amino forte",
    description: "To trái, đâm chồi, bóng lá, tăng sức sống, đề kháng cây",
    id: 5,
    animationDuration: "1.2s",
  },
];
...
export const PRODUCT_DETAILS = [
  {
    ...
    notes: [
      "Pha 500ml phân bón với 400-500 lít nước.",
      "Sử dụng định kỳ 7-10 ngày/lần.",
      "Phù hợp cho mọi giai đoạn sinh trưởng của cây trồng.",
    ],
    skills: [
      "Bổ sung dưỡng chất giúp cây phát triển khỏe mạnh, đặc biệt là trong giai đoạn đậu trái.",
  ...
  },
  {
    ...
    notes: [
      ...
      "Pha 500ml phân bón với 400-500 lít nước.",
      "Phun định kỳ 7-10 ngày/lần để đạt hiệu quả tối ưu.",
    ],
    skills: [
      "Tăng sức sống hạt phấn và kéo dài thời gian thụ phấn.",
  ...
  },
  {
    ...
    notes: [
      "Pha 250ml với 200 lít nước.",
      "Phun trong giai đoạn trước khi ra hoa và phục hồi bộ rễ",
      "Phun định kỳ 7-10 ngày/lần để đạt hiệu quả tốt nhất.",
    ],
    skills: [
      "Giúp phân hóa mầm hoa, kích thích quá trình tạo nụ hoa nhanh và đồng đều.",
  ...
  },
  {
    ...
    notes: [
      "Pha 500ml Silika K+ với 500 lít nước.",
      "Phun định kỳ 7-10 ngày/lần để đạt hiệu quả tối ưu.",
      "Sử dụng cho tất cả các giai đoạn phát triển của cây trồng.",
    ],
    skills: [
      "Tăng cường sức đề kháng của cây trồng đối với nấm bệnh, vi khuẩn, sâu hại.",
  ...
  },
  {
    ...
    items: [
      ...
      "Amino tự do: 22% (w/w), 26.4% (w/v)",
      "C/N: 7.5,",
      "Tỷ trọng: 1.2",
    ],
    notes: [
      "Pha 500ml Amino Forte OM 40% với 400-500 lít nước.",
      "Phun định kỳ 7-10 ngày/lần trong các giai đoạn phát triển của cây trồng.",
    ],
    skills: [
      "Bổ sung lượng lớn amino (37%), trong đó gồm Glycine (9.1%), Glutamic (5.1%) và Alanine (4.6%) giúp tăng kích thước, bóng trái và chống rụng.",
      "Dự trữ dinh dưỡng cho quá trình tổng hợp protein và enzyme giúp cây trồng phát triển mạnh.",
